...
$laminado = new Laminado();
  ...
  $foliohit=isset($_POST['folioihit'])? limpiarCadena($_POST["foliiohit"]):"";
  $operador=isset($_POST['operador'])? limpiarCadena($_POST["operador"]):"";
  $metros_corte_empalme=isset($_POST['metros_corte_empalme'])? limpiarCadena($_POST["metros_corte_empalme"]):"";
  $desperdicio=isset($_POST['desperdicio'])? limpiarCadena($_POST["desperdicio"]):"";
  $desperdicio_almacen_tela=isset($_POST['desperdicio_almacen_tela'])? limpiarCadena($_POST["desperdidio_almacen_tela"]):"";
